...
# Функция для загрузки и объединения данных для d=1 и d=5
...
def run_classification():
    print("\n=== Оценка для объединенных признаков (d=1 и d=5, G=256) ===")
    ...
    results_df.to_csv('classification_results_combined.csv', index=False)
    print("\nРезультаты сохранены в 'classification_results_combined.csv'")
